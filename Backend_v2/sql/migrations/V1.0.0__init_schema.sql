...
-- 创建默认管理员账户 - 使用角色检查而不是username
DO $$
BEGIN
    -- 检查是否已存在超级管理员账户
    IF NOT EXISTS (SELECT 1 FROM userinfo WHERE role = 'superadmin') THEN
        ...
        VALUES (
            ...
            'wecom_id', 
            'default_department',
            'https://weavatar.com/avatar/a12172cc89e35b5c4482afdb1f76b98c8c6bf3aa6aa4b4001c401638c6780ab2?s=512&d=mm&r=g'
        );
    END IF;
END$$;
