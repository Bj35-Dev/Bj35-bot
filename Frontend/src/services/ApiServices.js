...
export default {
  // 用户相关服务
  getLoginUserInfo: UserService.getLoginUserInfo.bind(UserService),
  getLoginUserAvatar: UserService.getLoginUserAvatar.bind(UserService),
  updateUserProfile: UserService.updateLoginUserProfile.bind(UserService),
